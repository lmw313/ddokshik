...
%>
      	 ...
      	 번호 :<p> <input type = "text" name = "list_no"></p>
          재료 이름 : <p><input type = "text" name = "list_name"></p>
            재료 무게 : <p><input type = "text" name = "food_gram"></p>
            유통기한 :<p> <input type = "text" name = "expdate"></p>
             칼로리 : <p><input type = "text" name = "cal"></p>
